...
import com.carrot.paysdk.impl.CarrotPaySDK;
import com.example.testandroidgradle.util.SystemUiHider;
...
public class FullscreenActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        csdk = new CarrotPaySDK(this);
        csdk.carrot_initPaySDK(1, "", "测试SDK", "凯罗天下", "123456789");
        ...
        contentView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
            	//在这里调起支付SDK
            	csdk.carrot_Pay(1, "108462", "001", true, true, "001", "", "", "", "", "", "", "1216461645441616",new CarrotPayCallBack() {
